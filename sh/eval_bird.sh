...
POST_PROCESS_MODE=Gre   # [Maj]

PRED_SQL_PATH=results/birddev-generated_sql_base.json
...
GROUND_TRUTH_SQL_PATH=data/NL2SQL/BIRD/dev_20240627/dev.sql
GROUND_TRUTH_JSON_PATH=data/NL2SQL/BIRD/dev_20240627/dev.json
DB_ROOT_PATH=data/NL2SQL/BIRD/dev_20240627/dev_databases/
NUM_CPUS=64
META_TIME_OUT=30.0
MODE_GT=gt
MODE_PREDICT=gpt
