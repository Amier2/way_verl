...
DATA_DIR_PATH=data/NL2SQL/BIRD
RUN_ID=3B
GPU_ENV=4GPU
MODEL_ENV=logs/nl2sql/4GPU-models/Qwen2.5-3B-Instruct-3B/global_step_100/actor/huggingface
PROJECT_NAME=nl2sql
...
python -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_DIR_PATH/train_rl.parquet \
    data.val_files=$DATA_DIR_PATH/test_rl.parquet \
